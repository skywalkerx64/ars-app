        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav flex-column mt-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link collapsed active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-3" aria-controls="submenu-2"><i class="mdi mdi-contact-mail"></i>Agents</a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/livraisons"><i class="mdi mdi-truck-delivery"></i>Livraisons<span class="badge badge-secondary">New</span></a>
                    </li>
                                        <li class="nav-item">
