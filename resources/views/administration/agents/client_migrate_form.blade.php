            ...
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Migration du client {{$client->nom}} {{$client->prenom}}</li>
                    </ol>
                </nav>
            </div>
        </div>
...
@section('content')
<div class="col-12">
    <form action="/client/migrate" method="post">
        @csrf
    <div class="card col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
        ...
        @endif
            ...
            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <label for="Id client" class="col-form-label">Id client</label>
                <input id="client" name="client" type="text" class="form-control" placeholder="client" value="{{ $client->tag }}">
            </div>
            <input name="id_c" type="hidden" value="{{ $client->id }}">
