            ...
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Recrutrement d'agent</li>
                    </ol>
                </nav>
            </div>
        </div>
...
@section('content')
<div class="col-12">
    <form action="/agents/ajouter" method="post">
        @csrf
    <div class="card col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
        ...
        @endif
            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                ...
                <input id="nom" name="nom" type="text" class="form-control" placeholder="Nom" value="{{ old('nom') }}">
            </div>

            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <label for="prenom" class="col-form-label">Prenom</label>
                <input id="prenom" name="prenom" type="text" class="form-control" placeholder="Prenom" value="{{ old('prenom') }}">
            </div>

            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <label for="adresse" class="col-form-label">Adresse</label>
                <input id="adresse" name="adresse" type="text" class="form-control" placeholder="Adresse" value="{{ old('adresse') }}">
            </div>

            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <label for="age" class="col-form-label">Age</label>
                <input id="age" name="age" type="number" class="form-control" placeholder="ans" value="{{ old('age') }}">
            </div>

            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <label for="sexe" class="col-form-label">Sexe</label>
                <input id="sexe" name="sexe" type="text" class="form-control" placeholder="M ou F" value="{{ old('sexe') }}">
            </div>

            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <label for="contact" class="col-form-label">Contact</label>
                <input id="contact" name="contact" type="number" class="form-control" placeholder="+229" value="{{ old('contact') }}">
            </div>

            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <label for="contact urgence" class="col-form-label">Contact d'urgence</label>
                <input id="contact urgence" name="urgence_contact" type="number" class="form-control" placeholder="+229" value="{{ old('urgence_contact') }}">
            </div>

            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <label for="region" class="col-form-label">Diplome</label>
                <input id="diplome" name="diplome" type="text" class="form-control" placeholder="Diplome" value="{{ old('diplome') }}">
            </div>
