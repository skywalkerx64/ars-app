...
<div class="row">
    ...
    <div class="col-xl-4 col-lg-4 col-md-8 col-sm-12 col-12">
        ...
        <div class="card border-3 border-top border-top-primary">
            <div class="card-body">
                <h5 class="text-muted"><a href="/caisse/{{$caisse_fc->tag}}">Frais de conversion de carte</a></h5>
                <div class="metric-value d-inline-block">
                    <h1 class="text-2xl my-3">{{$caisse_fc->solde}} XOF</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card border-3 border-top border-top-primary">
            <div class="card-body">
                <h5 class="text-muted"><a href="/caisse/{{$caisse_l->tag}}"><h5>Caisse des livraisons</a></h5>
                <div class="metric-value d-inline-block">
                    <h1 class="text-2xl my-3">{{$caisse_l->solde}} XOF</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-4 col-lg-4 col-md-8 col-sm-12 col-12">
        <div class="card border-3 border-top border-top-primary">
            <div class="card-body">
                <h5 class="text-muted"><a href="/caisse/{{$caisse_ca->tag}}"><h5>Caisse de l'agence</a></h5>
                <div class="metric-value d-inline-block">
                    <h1 class="text-2xl my-3">{{$caisse_ca->solde}} XOF</h1>
                </div>
            </div>
        </div>
    </div>
