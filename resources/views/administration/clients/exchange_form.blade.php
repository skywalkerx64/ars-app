...
@section('content')
<div class="col-12">
    <form action="/carte/changer" method="post">
        @csrf
    <div class="card col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
        ...
        <div class="card-body">
            ...
            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <label for="carte_m" class="col-form-label">Carte mère</label>
                <input id="carte_m" name="carte_m" type="text" class="form-control" placeholder="carte mère" value="{{ $carte->tag }}" required>
            </div>
            ...
            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                ...
                <input id="produit_1" name="produit_1_id" type="text" class="form-control" placeholder="Produit n°1">
            </div>

            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <label for="Agent" class="col-form-label">Produit n°2</label>
                <input id="produit_2" name="produit_2_id" type="text" class="form-control" placeholder="Produit n°2">
            </div>

            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <label for="Agent" class="col-form-label">Produit n°3</label>
                <input id="produit_3" name="produit_3_id" type="text" class="form-control" placeholder="Produit n°3">
            </div>

            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <label for="Agent" class="col-form-label">Produit n°4</label>
                <input id="produit_4" name="produit_4_id" type="text" class="form-control" placeholder="Produit n°4">
            </div>
