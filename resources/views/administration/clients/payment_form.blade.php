    ...
    <div class="card col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
        ...
        <div class="card-body">
            ...
            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                ...
                <input id="Agent" name="agent" type="text" class="form-control" placeholder="{{ $agent->nom }} {{ $agent->prenom }}" value="{{ $agent->tag}}" required>
            </div>
            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <label for="client" class="col-form-label">Client</label>
                <input id="client" name="client" type="text" class="form-control" placeholder="{{ $client->nom }} {{ $client->prenom }}" value="{{ $client->tag }}" required>
            </div>
            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <label for="carte" class="col-form-label">carte</label>
                <input id="carte" name="carte" type="text" class="form-control" value="{{ $carte->tag }}" required>
            </div>
            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <label for="montant" class="col-form-label" id="price_label">Montant</label>
                <input id="montant" name="montant" type="number" class="form-control" placeholder="" value="{{ $carte->cout }}" required>
            </div>
            <input type="hidden" id="count" value="{{ $carte->cout }}">
...
<script>
    ...
    var price = document.getElementById('montant');
    price.addEventListener("keyup", function(){
    label.innerHTML= price.value/count.value+' mises';
